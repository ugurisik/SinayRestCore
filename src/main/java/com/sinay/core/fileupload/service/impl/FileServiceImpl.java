package com.sinay.core.fileupload.service.impl;
...
import com.sinay.core.fileupload.entities.UploadedFile;
import com.sinay.core.fileupload.entities.QUploadedFile;
...
import com.sinay.core.fileupload.service.FileStorageService;
import com.sinay.core.fileupload.service.FileValidationService;
import com.sinay.core.fileupload.service.ImageProcessingService;
...
public class FileServiceImpl implements FileService {
    ...
    public void deleteFile(UUID fileId, UUID userId) {
        ...
        if (!deleteResult.isSuccess()) {
            throw new RuntimeException("Dosya silinemedi: " + deleteResult.getError());
        }
