package com.sinay.core.fileupload.enums;
...
public enum FileCategory {
     ...
     * @throws IllegalArgumentException Uzantı desteklenmiyorsa
     */
    public static FileCategory fromExtension(String extension) {
        if (extension == null || extension.isBlank()) {
            throw new IllegalArgumentException("Dosya uzantısı null veya boş olamaz");
        }
     ...
     * @return İlgili FileCategory
     * @throws IllegalArgumentException MIME tipi desteklenmiyorsa
     */
    public static FileCategory fromMimeType(String mimeType) {
        if (mimeType == null || mimeType.isBlank()) {
            throw new IllegalArgumentException("MIME tipi null veya boş olamaz");
        }
